...
public class TestWeatherJSONParser extends TestCase
{
  ...
  {
    String addr = "227 EnnismoreLn Brentwood TN 37027";
    WeatherJSONParser.geocoding(addr);
  }
